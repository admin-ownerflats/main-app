...
const Amenities = () => {
  const roomOptions = ["Maintenance Staff", "Park", "Water Storage", "Lift(s)", "Security / Fire Alarm", "Visitor Parking", "Intercom Facility", "Feng Shui / Vaastu Compliant"];
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.question}>Amenities & USP's</Text>
