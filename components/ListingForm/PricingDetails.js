...
import CheckboxGroup from './PricingDetails/CheckBoxGroup';
import PropertyDetailsInput from './PricingDetails/ProprtyDetailsInput';

const PricingDetails = ({ onNext }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
                <Text style={styles.formHeading}>Add Pricing Details</Text>

                {/* Ownership Details */}
                <View style={styles.optionContainer}>
        <Text style={styles.question}>Ownership</Text>
        <View style={styles.optionsRow}>
          {renderOptions(['Freehold', 'Leasehold', 'Co-operative Society', 'Power of Attorney'], ownership, setOwnership)}
        </View>
{/* Pricing Details */}
        <Subheading text="Pricing Details" />
<PropertyPriceInput value={expectedPrice} onChange={setExpectedPrice} />
<CheckboxGroup />

{/* Unique Property */}
<Subheading text="What makes your property Unique?" />
